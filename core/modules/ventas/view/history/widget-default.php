...
$operations = OperationData::getAllByProductIdCutIdOficial($product->id,$cut->id);
?>
<div class="row">
	<div class="col-md-12">
<a href="index.php?view=historyn&product_id=<?php echo $_GET["product_id"];?>" class="btn btn-default pull-right btn-lg">Operaciones sin Factura <i class="glyphicon glyphicon-chevron-right"></i></a>
...
<div class="row">
	...
	<?php
$itotal = OperationData::GetInputQYesF($product->id,$cut->id);
...
?>
	...
	<div class="col-md-4">
	<?php
$total = OperationData::GetQYesF($product->id,$cut->id);
...
?>
	...
	<?php
$ototal = -1*OperationData::GetOutputQYesF($product->id,$cut->id);
