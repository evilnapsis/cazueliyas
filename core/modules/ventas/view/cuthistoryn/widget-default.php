...
<div class="row">
	<div class="col-md-12">
<a href="index.php?view=cuthistory&product_id=<?php echo $_GET["product_id"];?>&cutid=<?php echo $_GET["cutid"]; ?>" class="btn btn-default pull-right btn-lg"><i class="glyphicon glyphicon-chevron-left"></i> Operaciones con Factura </a>

<h1><i class="glyphicon glyphicon-time"></i> Historial</h1>
<h2><?php echo $product->name;; ?> <small>Operaciones sin factura</small></h2>
	</div>
	</div>
...
<div class="row">
	...
	<?php
$itotal = OperationData::GetInputQNoF($product->id,$_GET["cutid"]);
...
?>
	...
	<div class="col-md-4">
	<?php
$total = OperationData::GetQNoF($product->id,$_GET["cutid"]);
