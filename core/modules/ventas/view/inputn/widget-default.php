...
<div class="row">
  <div class="col-md-8">
<a href="index.php?view=input&product_id=<?php echo $product->id; ?>" class="btn btn-default btn-lg pull-right">Alta con Factura</a>
  <div style="font-size:34px;">Alta en inventario <small style="color:#666;font-size:24px;">Sin factura</small></div>
